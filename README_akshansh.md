...
| Field | Details |
|-------|---------|
| **Student Name** | Akshansh Srivastava |
| **Registration Number** | 24BEY10081 |
...
```bash
git clone https://github.com/[your-username]/oss-audit-24BEY10081.git
cd oss-audit-24BEY10081
```
...
- **Student:** Akshansh Srivastava
- **Registration:** 24BEY10081
